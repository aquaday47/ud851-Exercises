...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadSizeFromSharedPrefs(sharedPreferences);
    ...
    private void loadSizeFromSharedPrefs(SharedPreferences sharedPrefs){
        float minSize = Float.parseFloat(sharedPrefs.getString(getString(R.string.pref_size_key),
